...
public class EducationCourse {
    public static void main(String[] args) {
        ...
        OnlineCourse onlineCourse = new OnlineCourse("Web Development", 8, "Simplilearn", true);
        PaidOnlineCourse paidCourse = new PaidOnlineCourse("Advanced Data Science", 12, "Oracle", true, 500, 20);
